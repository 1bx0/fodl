...
// Link to original file: https://github.com/Uniswap/v3-periphery/blob/7c987c2a5131193d36d51001b1b04be907b0ba06/contracts/lens/QuoterV2.sol
// Note that even if we could just link this via hardhat fork, we deploy it in local environment
...
contract QuoterV2 is IQuoterV2, IUniswapV3SwapCallback, PeripheryImmutableState {
    ...
    function uniswapV3SwapCallback(
        ...
        require(amount0Delta > 0 || amount1Delta > 0, 'Insufficient liquidity'); // swaps entirely within 0-liquidity regions are not supported
